...
================================
-run_ALE.sh (shell script for temporarily setting environment variables and executing the 
             application)
   -to run the shell script, type
   
       ./run_ALE.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2022b, run the shell script as:
       ...
       ./run_ALE.sh /mathworks/home/application/R2022b
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_ALE.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure ALE.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r ALE.zip ALE.app
    or the tar command 
    tar -cvf ALE.tar ALE.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/R2022b/runtime/maci64:MR/R2022b/sys/os/maci64:MR/R2022b/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_ALE.sh 
